/**
 * SQLite database access layer for the Estonian Cybersecurity (RIA/CERT-EE) MCP server.
 *
 * Schema:
 *   - guidance    — RIA cybersecurity guidelines, directives, and technical standards
 *   - advisories  — CERT-EE security advisories and incident alerts
 *   - frameworks  — RIA framework series (ISKE, cybersecurity requirements, guidance series)
 *
