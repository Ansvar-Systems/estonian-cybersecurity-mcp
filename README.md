...
[![npm version](https://badge.fury.io/js/%40ansvar%2Festonian-cybersecurity-mcp.svg)](https://www.npmjs.com/package/@ansvar/estonian-cybersecurity-mcp)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![CI](https://github.com/Ansvar-Systems/estonian-cybersecurity-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/estonian-cybersecurity-mcp/actions/workflows/ci.yml)
...
**Endpoint:** `https://mcp.ansvar.eu/estonian-cybersecurity/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add estonian-cybersecurity-mcp --transport http https://mcp.ansvar.eu/estonian-cybersecurity/mcp` |
...
```json
{
  "mcpServers": {
    "estonian-cybersecurity-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/estonian-cybersecurity/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/estonian-cybersecurity-mcp
```
...
```json
{
  "mcpServers": {
    "estonian-cybersecurity-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/estonian-cybersecurity-mcp"]
    }
  }
}
```
